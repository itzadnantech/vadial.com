...
<body>
@include('super_admin.template.header', ['menu' => 'customer'])
<div class="content">
    <div class="row margin-top-30">
        <div class="col-lg-1 col-md-1 col-sm-12 col-xs-12">
        </div>
        <div class="col-lg-11 col-md-11 col-sm-12 col-xs-12 ">
            <h6>CUSTOMER ACCOUNT <i class="fa fa-angle-right"></i> VIEW AND MANAGE YOUR ACCOUNT</h6>
            <button class="btn btn-primary margin-top-10" data-toggle="modal" data-target="#myModal">Customer Account</button>
                            ...
                            <div class="form-card-div margin-top-30">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                        <h2 class="account-inform">Customer Information</h2>
                                    </div>
                                </div>
                                <form method="post" action="{{ url('/super/add_admin') }}" id="add_account_form">
                                    @csrf
                    ...
                    @if (isset($users))
                        @foreach ($users as $user)
                            <tr>
                                ...
                                <td class="show_users">
                                    <button class="btn  btn-primary bg-dark-blue" onclick="view_admin('{{ url('/super/get_admin/' . $user->user_id) }}')"><i class="fa fa-edit"></i></button>
                                    <button type="button" class="btn btn-primary"><i class="fa fa-trash" onclick="remove_user('{{ url('/super/delete_admin/' . $user->user_id) }}')"></i></button>
                                    <a href="#"><button class="btn  btn-danger"><i class="fa fa-user-plus"></i></button></a>
                                    <a href="#"><button class="btn  btn-primary"><i class="fa fa-eye"></i></button></a>
                                </td>
                            </tr>
                        @endforeach
                    @endif
                    <div class="modal" id="manager_model">
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="row margin-bottom-30">
                                        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-2">
                                            <div class="circle">
                                                ...
                                                <input type="file" id="admin_image_file" name="image" accept="image/x-png,image/gif,image/jpeg" style="display: none" />
                                            </div>

                                        </div>
                                        <form method="post" action="{{ url('/super/change_admin_email') }}" id="change_email_form">
                                            @csrf
                                            <input type="hidden" value="" name="user_id" id="user_id" class="user_id">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <form method="post" action="{{ url('/super/change_admin_password') }}" id="change_password_form">
                                                @csrf
                                                <input type="hidden" value="" name="user_id" id="user_id" class="user_id">
