...
<div class="content">
    <div class="row">
        @include('admin.account.template.header', ['menu' => 'managers'])
        <div class="col-lg-10 col-md-10 col-sm-12 col-xs-12 margin-top-30">
            <h6>MANGER <i class="fa fa-angle-right"></i> ADD A NEW MANAGER</h6>
                    ...
                    @if (isset($users))
                        @foreach ($users as $user)
                            <tr>
                                ...
                                <td class="show_users">
                                    <button class="btn  btn-primary bg-dark-blue" onclick="view_manager('{{ url('/admin/account/get_account/' . $user->user_id) }}')"><i class="fa fa-edit"></i></button>
...
<script>
    ...
    function view_manager(index_url){
        $.ajax({
            url: index_url,
