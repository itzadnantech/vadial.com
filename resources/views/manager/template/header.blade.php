    ...
    <ul class="navbar-nav ml-3 ml-auto">
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu">
                <a class="dropdown-item" href="{{ url('/manager/manage_account') }}"><i class="fa   fa-user-o color-grey"> Manage Account</i></a>
...
<div class="icon-bar1">
    <a href="{{ url('/manager/home') }}" class="linkedin @if(isset($tab) && $tab == 'home') iconbar-purple @endif"><i class="fa fa-home"> </i></a>
    ...
    <a href="{{ url('/manager/agents') }}" class=" @if(isset($tab) && $tab == 'agents') iconbar-purple @endif"><i class="fa fa-gear"></i></a>
</div>
