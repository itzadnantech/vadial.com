...
<body>
	<nav class="navbar navbar-expand-md" style="position: sticky !important; top: 0; z-index: 1; width: 100%; background-color: white;">
    	<a href="dashboard.html"><img src="asset/images/logo.png" class="logo-img1"></a>
...
<li class="nav-item dropdown">
					...
					<div class="dropdown-menu">
						<a class="dropdown-item" href="#"><i class="fa   fa-user-o color-grey"> Manage Account</i></a>
						<a class="dropdown-item" href="#"><i class="fa   fa-sign-in color-grey"> Log Out</i></a>
					</div>
				</li>
...
<!-----<div class="side-bar1"></div>---------->
       ...
       <div class="icon-bar1">
             <a href="Agent%20Panel%20home.html" class="linkedin"><i class="fa fa-home"> </i></a>
  ...
  <a href="Agent%20Panel%20call%20person.html" class="google iconbar-purple"><i class="fa  fa-phone"> </i></a> 
     ...
     <div class="content">
         ...
         <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
            <div class="bg-gray" style="padding-bottom: 20px;">
              ...
              <input type="date" class="form-control margin-top-10" id="InvoiceDate" placeholder="15/02/2021" name="uname" required="">
                   </div>
             ...
             <div class="row margin-top-10">
                    <div class="col-lg-10 col-md-8 col-sm-12 col-xs-12 display-flex">
  ...
  <select name="cars" id="cars" class="margin-left-10 margin-top-10">
    <option value="volvo" class="margin-top-10">10</option>
             ...
             <p class="mange">showing 0 to 0 of 0 entries</p>
             

             </div>
                         <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
                 <form action="/action_page.php" class="margin-top-30">
